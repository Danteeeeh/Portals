    ...
    <div class="dashboard-container">
        ...
        <aside class="sidebar">
            ...
            <nav class="nav-menu" role="navigation" aria-label="Main navigation">
                <button data-page="dashboard" onclick="window.location.href='../Studentportal/studentdashboard.php'" class="nav-btn btn-secondary" aria-label="Go to Dashboard">
                ...
                <button data-page="progress" onclick="window.location.href='../Studentportal/studentprogress.php'" class="nav-btn btn-purple" aria-label="View Student Progress">
                    <span class="btn-icon" aria-hidden="true">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                            <path d="M12 20V10"/>
                            <path d="M18 20V4"/>
                ...
                <button data-page="tasks" onclick="window.location.href='../Studentportal/upcomingtasks.php'" class="nav-btn btn-blue" aria-label="View Upcoming Tasks">
                    <span class="btn-icon" aria-hidden="true">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                            <path d="M8 6h13"/>
                            <path d="M8 12h13"/>
                ...
                <button data-page="concerns" onclick="window.location.href='../Studentportal/Concern.php'" class="nav-btn btn-blue" aria-label="View Concerns">
                    <span class="btn-icon" aria-hidden="true">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                ...
                <button onclick="window.location.href='../Studentportal/logout.php'" class="nav-btn btn-red" aria-label="Logout">
                    <span class="btn-icon" aria-hidden="true">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
